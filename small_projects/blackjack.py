...
def main():
    print('''Blackjack, by Michael Francis
    Rules:
    ...
    In case of a tie, the bet is returned
    ...
    while True:  # Main Loop
        ...
        print(f'Bet: {bet}')
        while True:  # Keep loopint till player stands or busts
            ...
            if move in ('H', 'D'):
                ...
                new_card = deck.pop()
                rank, suit = new_card
                print(f'You drew a Card: {rank} of {suit}')
        ...
        if get_hand_value(dealer_hand) <= 21:
            ...
            if dealer_value > 21:
                ...
                print(f'You lost! Dealer wins: {bet}!')
                money -= bet
